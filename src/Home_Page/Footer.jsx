...
function Footer() {
  ...
  <Element name="contact" className='footer_page'>
   <div className='footer_about'>
    <div className='orderIcon_footer'><FontAwesomeIcon className='icon_footer' icon={faPhoenixFramework} /><h4 style={{display:"inline"}}><span>O</span>rder<span>H</span>ub</h4></div>
   ...
   <div className='footer_flex_icons'>
    ...
    <a style={{color:"white"}} href="#"><FontAwesomeIcon icon={faTwitter} /></a>
    <a style={{color:"white"}} href="#"><FontAwesomeIcon icon={faYoutube} /></a>
